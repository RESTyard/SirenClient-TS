...
export const navigate = <T, R>(project: (value: T, index: number) => Observable<Result<R, ProblemDetailsError>>): OperatorFunction<Result<T, ProblemDetailsError>, Result<R, ProblemDetailsError>> => {
